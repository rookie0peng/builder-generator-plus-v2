...
public class RegenerateBuilderAdditionalAction extends AbstractBuilderAdditionalAction {
    ...
    public static final RegenerateBuilderAdditionalAction INSTANCE = new RegenerateBuilderAdditionalAction();

    private static final String TEXT = "Regenerate builder generator plus...";
